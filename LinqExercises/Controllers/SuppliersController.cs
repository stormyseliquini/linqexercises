...
namespace LinqExercises.Controllers
{
    public class SuppliersController : ApiController
    {
        ...
        public IHttpActionResult GetSalesAndMarketing()
        {
            ...
            var marketingSalesFax = _db.Suppliers.Where(s => (s.ContactTitle == "Marketing Manager" || s.ContactTitle == "Sales Representative") && (s.Fax != null));
            return Ok(marketingSalesFax);
        }
        ...
        public IHttpActionResult SearchSuppliers(string term)
        {
            ...
            var supplierSearch = _db.Suppliers
                                .Where(s => s.Address.Contains(term)).OrderBy(s => s.CompanyName);
            return Ok(supplierSearch);
        }
